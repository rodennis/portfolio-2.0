...
function Socials() {
  return (
    <div>
      ...
      <a target='_blank' rel="noreferrer" href="https://drive.google.com/file/d/1Yd5S7xiTrOLdxam90VvAI9u7fVrud2V9/view"><img className='socials' src={ resume } alt="resume"/></a>
    </div>
  )
}
